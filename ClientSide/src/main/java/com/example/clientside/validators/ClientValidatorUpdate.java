...
public class ClientValidatorUpdate {
    public static List<String> validateWholeDataForUser(String email, String firstName, String lastName, String phoneNumber, LocalDate dateOfBirth) {
